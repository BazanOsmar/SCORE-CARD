...
export const LightBulbIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-1.946m9-5.995h.008v.008H21v-.008zM12 3a9 9 0 019 9 4.5 4.5 0 01-1.125 3.512c-.622.565-1.722 1.635-1.722 3.116 0 1.244-.756 2.381-1.946 2.381H9.796c-1.19 0-1.946-1.137-1.946-2.381 0-1.481-1.1-2.551-1.722-3.116A4.5 4.5 0 013 12a9 9 0 019-9z" />
  </svg>
);